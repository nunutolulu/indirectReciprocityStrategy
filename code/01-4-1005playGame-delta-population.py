...
if __name__ == "__main__":
    ...
    # 输出
    payoff_mean_time.to_csv('output/payoff_mean_time_delta_2_population.csv', index=True, encoding='utf-8')
    repu_time.to_csv('output/repu_time_delta_2_population.csv', index=True, encoding='utf-8')
    propotion_time.to_csv('output/propotion_time_delta_2_population.csv', index=True, encoding='utf-8')
