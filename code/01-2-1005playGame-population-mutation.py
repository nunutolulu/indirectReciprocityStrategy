...
if __name__ == "__main__":
    ...
    def chooseTwoAction(index_list, individual_strategy, repu):
        ...
        action_self = eval(one_strategy)(one_repu, another_repu)
        action_oppo = eval(another_strategy)(another_repu, one_repu)
    ...
    # 输出
    payoff_mean_time.to_csv('output/payoff_mean_time_population_mutation.csv', index=True, encoding='utf-8')
    repu_time.to_csv('output/repu_time_population_mutation.csv', index=True, encoding='utf-8')
    propotion_time.to_csv('output/propotion_time_population_mutation.csv', index=True, encoding='utf-8')
